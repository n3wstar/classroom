...
export class ClickableAreasService {
  ...
  async create(
    ...
    if (!schema) {
      throw new NotFoundException(`Схема этажа не найдена`);
    }
